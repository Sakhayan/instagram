	...
	<div class="col-6 mx-auto" > <!--ГЛАВНЫЙ БЛОК-->
		<div class="row"> 
			<form action="insta.php" method="GET">
				<input  placeholder="id" type="" name="id">
				<input placeholder="text" type="" name="text">
				<input placeholder="img" type="" name="img">
				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<form action="delete.php" method="GET">
							<input value='<?php echo $result["id"] ?>' class="form-control" name="id" style='display:none'>
